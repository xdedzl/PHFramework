...
namespace PHFramework.Editor
{
    ...
    public static class MenuExtend
    {
        ...
        [MenuItem("PHFramework/GenerateScriptsGUIDFile")]
        public static void GenerateScriptsGUIDFile()
        {

            string fullPath = Path.Combine(PHApplication.dataPath, "Assets", "PHFramework");
            ...
            string savePath = Path.Combine(PHApplication.dataPath, "ProjectSettings", "ScriptsGuid.txt");
            File.WriteAllLines(savePath, file2guid);
        }

        [MenuItem("PHFramework/UpdatePrefabScriptGUID")]
