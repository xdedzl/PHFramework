...
namespace PHFramework.Editor
{
    ...
    {
        [MenuItem("PHFramework/UI/QuickGenCode")]
        ...
        private List<PHUIBase> baseGUIList;
        ...
        private void RefreshUIList()
        {
            ...
            {
                baseGUIList = new List<PHUIBase>(root.GetComponentsInChildren<PHUIBase>());
            ...
            {
                PHUIBase[] tempArray = root.GetComponentsInChildren<PHUIBase>();
