...
namespace PHFramework.UI
{
    ...
    public class PanelBase : MonoBehaviour
    {
        ...
        private ComponentFindHelper<PHUIBase> m_ComponentFindHelper;
        ...
        {
            Name = name;
            m_ComponentFindHelper = ComponentFindHelper<PHUIBase>.CreateHelper(this.gameObject);
        ...
        /// Find UI组件的索引器
        /// </summary>
        public PHUIBase this[string key]
        {
            get
            {
