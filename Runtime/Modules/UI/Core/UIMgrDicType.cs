...
namespace PHFramework.UI
{
    ...
    public class UIMgrDicType : IUIManager
    {
        ...
        public UIMgrDicType()
        {
            ...
            if (m_ResMgr == null)
            {
                throw new PHFrameworkException("[UIMgr] 加载UI模块之前需要加载Resource模块");
            }
        }
        ...
        public PanelBase GetPanel(string uiname)
        {
            ...
            {
                if (panel == null)
                    throw new PHFrameworkException("[UI] The panel you want has been unloaded");
                return panel;
            }
            else
            {
                ...
                {
                    throw new PHFrameworkException("[UI] wrong panel name or panel is not inherit BasePanel");
                }
