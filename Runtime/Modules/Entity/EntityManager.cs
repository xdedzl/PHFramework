    ...
    public partial class EntityManager : GameModuleBase<EntityManager>
    {
        ...
        public Entity Allocate(int id, string key, IEntityData entityData, Vector3 pos, Quaternion quaternion, Transform parent)
        {
            ...
            if (m_EntityDic.ContainsKey(id))
            {
                ...
                throw new PHFrameworkException($"[EntityError] id is already occupied.  Entity {e.ToString()}");
            }
        ...
        public bool Recycle(Entity entity)
        {
            if (entity != null)
            {
                ...
                {
                    throw new PHFrameworkException("[Entity] this entity is not created by manager");
                }
            }
            return false;
        }
        ...
        private EntityContainer GetContainer(string containerName)
        {
            ...
            {
                throw new PHFrameworkException($"[EntityError] There is no entity container named {containerName}");
            }
        }
        ...
        public Entity GetEntity(int entityId)
        {
            ...
            {
                throw new PHFrameworkException($"[Entity] There is no entity with an id of {entityId}");
            }
        }
