...
namespace PHFramework
{
    public class Timer
    {
        ...
        public float timeScale
        {
            ...
            {
                if (value < 0)
                    throw new PHFrameworkException("the timeScale of Timer can not less than 0");
                m_timeScale = value;
            }
        }
        ...
        public string groupName
        {
            ...
            set
            {
                if (IsRunning)
                {
                    throw new PHFrameworkException("[Timer] running timer can not modify group name");
                }
                m_groupName = value;
            }
        }
        ...
        private class TimerManager : MonoBehaviour
        {
            ...
            private void Update()
            {
                ...
                foreach (var timer in m_toRemveTimers)
                {
                    ...
                    throw new PHFrameworkException("[Timer] try to delete a timer whitch is not managerd by TimeManager");
                }
            ...
            public IEnumerable<Timer> GetTimers(string groupName)
            {
                ...
                throw new PHFrameworkException($"[Timer] there is no timer group which name is {groupName}");
            }
        }
    }
}